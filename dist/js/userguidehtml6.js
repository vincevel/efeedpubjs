      ...
      <div class="container">
          ...
          <div class="row">
            <div class="col m12" >
                ...
                <ol>
                  <li class="flow-text"><p><strong>Confirming:</strong> Review all 40 strengths and identify the <strong><span style="color: yellow">10 strengths (do not do more or less than 10)</span></strong> that you see the most in the feedback receiver.  Select the 5 strengths by clicking on the <span class="yellowtext">YELLOW</span> Dots next to them under <span class="yellowtext">Confirm .</span> On the right side of each of selected strengths you will see a space provided to allow you to write specific comments, suggestions or feedback that you observed towards this person. Click on the (Save) button on the bottom of the page.</p></li>
